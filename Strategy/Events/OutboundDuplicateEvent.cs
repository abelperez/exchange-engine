...
namespace Exchange.Engine.Strategy.Events
{
    ...
    ///
    [Serializable]
    public class OutboundDuplicateEvent : GenericStrategyEvent
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// </summary>
        /// 
        public OutboundDuplicateEvent(string actor)
            : base(actor, typeof(OutboundDuplicateEvent).ToString(), "Outbound duplicate strategy checks for outgoing duplicates.")
        {
        }
        ...
        public override string ToXml()
        {
            ...
            xml.AppendFormat("<duplicate type=\"outbound\" email=\"{0}\" created=\"{1}\" guid=\"{2}\" >", Email, Created, Guid);
